...
- #### Home page user stories test cases:
    ...
    >**Result:** Pass
    - the home page features a [landing page](docs/user-stories/home-page-landing-laptop.png) (mobile view [here](docs/user-stories/home-page-landing-mobile.png)) with hero image and text stating: "Mindful Walking. Add some zen to your step". The user knows straight away that this website is dedicated to mindful walking. 
    ...
    - On clicking the button, they are brought to a [section](docs/user-stories/home-page-navigation-laptop.png) (mobile view [here](docs/user-stories/home-page-navigation-mobile.png)) displaying three options in boxes styled like cards so the user knows they can click on these:
        -   WHAT? Learn the basics
        -   WALK! Get started now
        -   WHY? Find out more <br>
    - It is clear to the user that they can click on "WHAT? Learn the basics" to bring them to a [section](docs/user-stories/home-page-intro-laptop.png) (mobile view [here](docs/user-stories/home-page-intro-mobile.png)) which will explain what Mindful Walking is.
    ...
    -  the user sees the "WALK! Get started now" button and clicks on this to bring them to the [Get Started section](docs/user-stories/home-page-get-started-laptop.png) (mobile view [here](docs/user-stories/home-page-get-started-mobile.png)).
    ...
    >**Result:** Pass
    - the user enters the site as described above and is brought to the three options described above.
    -  the user sees the "WHY? Find out more" button and clicks on this to bring them to the [More Reading section](docs/user-stories/home-page-more-reading-laptop.png) (mobile view [here](docs/user-stories/home-page-more-reading-mobile.png)).
    - here they can see a brief introduction to this section explaining what the articles are about and who writes them
    - a summary of each article is shown in a box, with accompanying image, article title and a link for the user to click on if they want to read the article. Once they are in the [article pages](docs/user-stories/article-page-top-laptop.png) (mobile view [here](docs/user-stories/article-page-top-mobile.png)), there are navigation arrows on the top and [bottom of the page](docs/user-stories/article-page-bottom-laptop.png) (mobile view [here](docs/user-stories/article-page-bottom-mobile.png)) to bring to the next or previous artice. Or they can return to home page/any of the other pages via the fixed navigation menu at the top of the page.
